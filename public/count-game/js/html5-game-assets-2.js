...
(lib.NumberedBox = function(mode,startPosition,loop) {
	...
	this.numberText.setTransform(0,-13.1);
...
}).prototype = getMCSymbolPrototype(lib.NumberedBox, new cjs.Rectangle(-24.4,-24.4,49,49), null);
...
// stage content:
(lib.html5game_workfile_v001 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
