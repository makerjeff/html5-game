...
(lib.GameOverView = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(152.1,227);
	...
	this.instance_1.setTransform(77.5,216.9,1,1,0,0,0,63.5,75.5);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(8).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(18));

	// bg_tile
	this.instance_2 = new lib.bg_tile();
	this.instance_2.parent = this;
	this.instance_2.setTransform(261.4,336.5,1,1,0,0,0,63.5,75.5);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(5).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(21));

	// bg_tile
	this.instance_3 = new lib.bg_tile();
	this.instance_3.parent = this;
	this.instance_3.setTransform(20.5,324.5,1,1,0,0,0,63.5,75.5);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(23).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(3));

	// bg_tile
	this.instance_4 = new lib.bg_tile();
	this.instance_4.parent = this;
	this.instance_4.setTransform(77.5,292.4,1,1,0,0,0,63.5,75.5);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(12).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(14));

	// bg_tile
	this.instance_5 = new lib.bg_tile();
	this.instance_5.parent = this;
	this.instance_5.setTransform(214.6,292.4,1,1,0,0,0,63.5,75.5);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(20).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(6));

	// bg_tile
	this.instance_6 = new lib.bg_tile();
	this.instance_6.parent = this;
	this.instance_6.setTransform(139.5,367.9,1,1,0,0,0,63.5,75.5);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(17).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(9));

	// bg_tile
	this.instance_7 = new lib.bg_tile();
	this.instance_7.parent = this;
	this.instance_7.setTransform(139.5,292.4,1,1,0,0,0,63.5,75.5);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(7).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(19));

	// bg_tile
	this.instance_8 = new lib.bg_tile();
	this.instance_8.parent = this;
	this.instance_8.setTransform(279.5,227.5,1,1,0,0,0,63.5,75.5);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(14).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(12));

	// bg_tile
	this.instance_9 = new lib.bg_tile();
	this.instance_9.parent = this;
	this.instance_9.setTransform(178.6,170.5,1,1,0,0,0,63.5,75.5);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(6).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(20));

	// bg_tile
	this.instance_10 = new lib.bg_tile();
	this.instance_10.parent = this;
	this.instance_10.setTransform(-1.4,181.5,1,1,0,0,0,63.5,75.5);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(3).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(23));

	// bg_tile
	this.instance_11 = new lib.bg_tile();
	this.instance_11.parent = this;
	this.instance_11.setTransform(289.5,0,1,1,0,0,0,63.5,75.5);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(8).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(18));

	// bg_tile
	this.instance_12 = new lib.bg_tile();
	this.instance_12.parent = this;
	this.instance_12.setTransform(279.5,106.5,1,1,0,0,0,63.5,75.5);
	this.instance_12.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({alpha:1},14,cjs.Ease.get(1)).wait(26));

	// bg_tile
	this.instance_13 = new lib.bg_tile();
	this.instance_13.parent = this;
	this.instance_13.setTransform(112.5,-5.5,1,1,0,0,0,63.5,75.5);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(1).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(25));

	// bg_tile
	this.instance_14 = new lib.bg_tile();
	this.instance_14.parent = this;
	this.instance_14.setTransform(204.5,19.5,1,1,0,0,0,63.5,75.5);
	this.instance_14.alpha = 0;
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(3).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(23));

	// bg_tile
	this.instance_15 = new lib.bg_tile();
	this.instance_15.parent = this;
	this.instance_15.setTransform(102.5,121.5,1,1,0,0,0,63.5,75.5);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(12).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(14));

	// bg_tile
	this.instance_16 = new lib.bg_tile();
	this.instance_16.parent = this;
	this.instance_16.setTransform(12.5,60.5,1,1,0,0,0,63.5,75.5);
	this.instance_16.alpha = 0;
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(6).to({_off:false},0).to({alpha:1},14,cjs.Ease.get(1)).wait(20));
